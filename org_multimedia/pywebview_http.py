"""Servidor HTTP de PyWebView con ruta /media en el mismo origen que la UI."""
...
class OrganizadorBottleServer(BottleServer):
    """Añade /media al servidor embebido de PyWebView (mismo puerto que dist/)."""
